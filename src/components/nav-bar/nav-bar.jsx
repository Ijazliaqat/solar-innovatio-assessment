                    ...
                    <div className="row d-flex align-items-center ">
                        ...
                        <div className="col-md-7 d-flex align-items-center justify-content-between">
                            <div className="d-flex align-items-center">
                                ...
                                <span className="font-poppins fs-16 fw-400 primary-text-color">0203 519 4420</span>
                            </div>
                            <div className="d-flex align-items-center">
                                <img className="mx-3" src={EmailSVG} alt="phone-icon" />
                                <span className="font-poppins fs-16 fw-400 primary-text-color">info@solarinnovatio.com</span>
                            </div>
                            <button type="button" className="btn primary-bg-color fs-16 fw-500 text-white font-inter">Contact Us</button>
                        </div>
                    </div>
