    ...
    <div>
      <section className="choose_your_SIRE mt-5 ">
        <div className="container-fluid container-lg">
          <h2 className="main_heading choose_your_SIRE_main_heading text-center darkgray-color font-poppins fs-36 fst-normal fw-600 line-height-30">
            Scegli il tuo SIRE
          </h2>
            ...
            <div className="col-md-6 ">
              <div className="card h-100 chose_your_sire_card">
                ...
                <div className="card-body choose_your_sire_body">
                  <h5 className="card-title font-poppins fst-normal fs-24 fw-600 line-height-20">
                    S.I.R.E Direct
                  </h5>
                  <ul className="chose_sire_list">
                    <li className="list_item lightgray-color font-poppins fs-16 fst-normal fw-400 line-height-10">
                      Sistema Plugin
                    </li>
                    <li className="list_item lightgray-color font-poppins fs-16 fst-normal fw-400 line-height-10">
                  ...
                  <h6 className="card_second_title darkgray-color font-inter fs-16 fst-normal fw-500 line-height-13">
                    CONSIGLIATO PER:
                  </h6>
                  <div className="recomended_for_card  d-flex align-items-center ">
                    <div className="small_card_wrapper">
                      ...
                      <p className="small_card_name lightgray-color font-poppins fs-16 fst-normal fw-400 line-height-17">
                        Devices
                      </p>
                    </div>
                    <div className="small_card_wrapper">
                  ...
                  >
                    <div className="accordion-item card_inner_accordion">
                      <h3 className="accordion-header" id="headingOne">
                        <button
                          className="accordion-button darkgray-color fst-normal font-poppins fs-16  fw-500 line-height-27 bg-white"
                          type="button"
                      ...
                      >
                        <div className="accordion-body Card_inner_accordionBody">
                          <ul className="List">
                            <li className=" mb-2 lightgray-color font-poppins fs-16 fst-normal fw-400 line-height-10">
      ...
      <section className="connect_to_sun_sect text-center mt-5">
        <div className="container-fluid container-lg pt-5">
          <h2 className="main_heading connect_to_sun_sect_main_heading text-center darkgray-color font-poppins fs-36 fst-normal fw-500 line-height-30">
              ...
              return (
                <>
                  <div key={item.id} className="col-sm-6 col-lg-3 colums ">
                    <div
                      className={`connet_to_sun_outer_wrapper ${item.className}`}
                    >
                      <div className="card connect_to_sun_card  h-100 d-flex align-items-center flex-column align-items-center ">
                        ...
                        <div className="card-body Why_SIRE_card_body connect_to_sun_body p-0">
                          <h5 className="card-title text-center font-inter fs-16 fst-normal fw-500 line-height-13 my-3">
                            {item.title}{" "}
                          </h5>
                          <p className="card-text text-center font-inter fs-14 fst-normal fw-400 line-height-17 ">
                            {item.description}
                          </p>
                        </div>
                      </div>
                      {item.id === 4 ? (
                        ...
                        <img
                          className="arrow_icon_wrapper d-none d-md-block darkgray-color"
                          src={item?.arrowImage}
                          alt=""
                        />
                      )}
